<template>
  <div class="hello">
    ...
    <div class="top">
      ...
      <div @click="active = 2" :class="{'onDiv': active === 2}">
        <p>
          <i class="iconfont icon-faqiyingyong"></i>
        </p>
        <h1>我发起的</h1>
      </div>
      <div @click="active = 3" :class="{'onDiv': active === 3}">
        <p>
    ...
    <!--已完成事项-->
    <div class="okFinish" v-if="active === 1">
      <div class="inRough">
        <div class="main">
          <div class="mainTop">
            <div onclick="alert(2)">
    ...
    <!--底部-->
    <div class="footer">
      <div @click="footActive = 1" :class="{'onDiv': footActive === 1}">
        <h2>
